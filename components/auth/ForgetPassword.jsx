...
const ForgetPassword = () => {
  ...
  const handleForgetPasswordSubmit = async (e) => {
    ...
    try {
      ...
      const res = await network.post(ApiPath.forgetPassword, requestBody);
      if (res.status === "completed") {
        toast.success(res.data.message);
        router.push(
          `/auth/login/forgot-password-otp?email=${encodeURIComponent(
            encryptedEmail
          )}`
        );
      }
      ...
      <div className="left w-full lg:w-[50%] mr-0 lg:mr-[50%] min-h-screen relative">
        ...
        <div className="left-content flex justify-center items-center min-h-screen pt-[100px] xl:pt-24 pb-[100px] xl:pb-24">
          <div className="min-w-full sm:min-w-[450px] mx-auto px-4 xl:px-0">
            <h2 className="text-[24px] text-merchant-text font-bold">
              Reset Your Password
            </h2>
            <div className="mt-[40px]">
              <form onSubmit={handleForgetPasswordSubmit}>
                ...
                <div className="mt-5 sm:mt-[30px] lg:mt-[40px] flex flex-col gap-4">
                  ...
                  <Link
                    href="/auth/login"
                    className="py-3 px-4 flex items-center justify-center gap-2 text-center rounded text-[14px] font-bold text-merchant-text"
                  >
                    <Icon
